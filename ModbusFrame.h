...
class ModbusFrame
{
  public:
    ...
    */
    ...
    @ingroup constant
    */
    static const uint8_t ku8MBInvalidID             = 0xE0;
    ...
    */
    ...
    // a received packet has an address, a function code and data
    uint8_t ReceivedAddress();
    uint8_t ReceivedFunctionCode();
    uint16_t ResponseBufferGetAt(uint8_t); //
    
    uint8_t  TransmitBufferPutAt(uint8_t offset, uint16_t value); //
  ...
  private:
    ...
    uint8_t LastReceivedAddress;
    uint8_t LastReceivedFunctionCode;
 ...
 //   static const uint8_t ku8MBWriteMultipleCoils         = 0x0F; ///< Modbus function 0x0F Write Multiple Coils
    ...
    static const uint8_t MODBUS03_ReadHoldingRegisters       = 0x03; ///< Modbus function 0x03 Read Holding Registers
    static const uint8_t MODBUS04_ReadInputRegisters         = 0x04; ///< Modbus function 0x04 Read Input Registers
//    static const uint8_t ku8MBWriteSingleRegister        = 0x06; ///< Modbus function 0x06 Write Single Register
    static const uint8_t MODBUS10_WriteMultipleRegisters     = 0x10; ///< Modbus function 0x10 Write Multiple Registers
...
//    static const uint8_t ku8MBReadWriteMultipleRegisters = 0x17; ///< Modbus function 0x17 Read Write Multiple Registers
    ...
    uint8_t SendFrame(uint8_t u8MBFunction, uint8_t address, uint16_t quantity, uint16_t Address, bool isClient);
    uint8_t ReceiveFrame(uint8_t ThisAddress, bool isClient);
